...
export const projectsData: ProjectData[] = [
  {
    id: 1,
    title: "Nick Academy",
    description: "An educational adventure game for children featuring interactive lessons, mini-games, and engaging storytelling across multiple subjects.",
    ...
    content: {
      ...
      keyFeatures: [
        ...
        "Custom dialogue system powered by Unity Ink for dynamic conversations",
      ...
      technicalHighlights: [
        "Implemented a robust dialogue system using Unity Ink, managing branching conversations and character interactions",
      ...
      myRole: [
        "Developed and integrated the DialogueSystem using Unity Ink, enabling writers to create branching narratives without code modifications",
    ...
    media: {
      ...
      showcaseVideos: [
        ...
        },
        {
          ...
          caption: "Dialogue System with Unity Ink"
        },
        {
